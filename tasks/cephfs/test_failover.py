...
class TestMultiFilesystems(CephFSTestCase):
    ...
    #
    # def test_standby_replay(self):
    #     # Configure one MDS as the standby replay for one FS, the other
    #     # for the other FS.
    #
    #     # Start everything up, see that everyone takes up the role that
    #     # they should in the filesystem that they should
    #     pass
    #
    # def test_epoch_propagation(self):
    #     # Two filesystems, two active MDS daemons, two clients
    #
    #     # Update something in one of the filesystems, see that one
    #     # daemon sees its epoch go up and the other does, and same
    #     # for the clients.
    #
    #     # Update something global (compat), see that all the daemons
    #     # and the clients see the new map.
    #
    #     pass
